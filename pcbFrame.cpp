...
// ............................................................................
IMPLEMENT_DYNCREATE(PCBFrame, CMDIChildWndEx)

BEGIN_MESSAGE_MAP(PCBFrame, CMDIChildWndEx)
	ON_WM_CREATE( )
	ON_MESSAGE( ID_POST_PCVIEW_FRAME, &OnViewPost )
	ON_UPDATE_COMMAND_UI( ID_INDICATOR_LABEL, &OnUpdateStatusText )
END_MESSAGE_MAP()
...
// ............................................................................
BOOL PCBFrame::PreCreateWindow( CREATESTRUCT& cs )
{
...
// ............................................................................
int PCBFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	statusBar.SetPaneStyle( statusBar.CommandToIndex( ID_INDICATOR_LABEL ), SBPS_NOBORDERS );
	statusBar.SetPaneTextColor( statusBar.CommandToIndex( ID_INDICATOR_LABEL ) );

	return 0;
}

// ............................................................................
void PCBFrame::OnUpdateStatusText( CCmdUI *pCmdUI )
{
	pCmdUI->Enable( );
...
LRESULT PCBFrame::OnViewPost( WPARAM pos, LPARAM )
{
	return 0;
}
...
// ............................................................................
#ifdef _DEBUG
void PCBFrame::AssertValid( ) const
{
	CMDIChildWndEx::AssertValid( );
}

void PCBFrame::Dump( CDumpContext& dc ) const
{
